...
https://docs.netapp.com/us-en/bluexp-backup-recovery/concept-backup-to-cloud.html["So verwenden Sie Cloud Backup, um ONTAP Daten zu sichern und wiederherzustellen"^].
