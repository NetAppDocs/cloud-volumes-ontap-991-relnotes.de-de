...
https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-backup-to-cloud.html["So verwenden Sie Cloud Backup, um ONTAP Daten zu sichern und wiederherzustellen"^].
