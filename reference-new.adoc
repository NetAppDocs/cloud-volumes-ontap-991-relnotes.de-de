...
+
link:https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-updating-ontap-cloud.html#upgrades-in-aws-with-c4-m4-and-r4-ec2-instance-types["Informieren Sie sich über das Upgrade in AWS mit den EC2-Instanztypen c4, m4 und R4^."]
